...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen app-shell flex flex-col">
      ...
      <footer className="shrink-0 border-t border-[var(--hairline)] bg-[var(--surface-0)]/80 px-6 py-3 flex items-center justify-between text-xs text-gray-500">
        <span className="font-mono tracking-tight">HarMonize</span>
        <a
          href="https://github.com/CodingFreeze/Harmonize"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="HarMonize on GitHub"
          className="inline-flex items-center gap-1.5 font-mono transition-colors hover:text-primary-300"
        >
